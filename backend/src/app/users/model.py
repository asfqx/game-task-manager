...
class User(Base):
    ...
    created_projects: Mapped[list["Project"]] = relationship(
        ...
        foreign_keys=lambda: [Project.creator_uuid],
    )

    created_teams: Mapped[list["Team"]] = relationship(
        "Team",
        back_populates="created_by",
        foreign_keys=lambda: [Team.created_by_uuid],
    )

    led_teams: Mapped[list["Team"]] = relationship(
        "Team",
        back_populates="lead",
        foreign_keys=lambda: [Team.lead_uuid],
    )

    team_memberships: Mapped[list["TeamMember"]] = relationship(
        "TeamMember",
        back_populates="user",
        foreign_keys=lambda: [TeamMember.user_uuid],
